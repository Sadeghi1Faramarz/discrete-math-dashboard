...
const SymmetricClosureCalculator = () => {
  ...
  return (
    <div className="project-page-wrapper">
      <header><h1>محاسبه‌گر بستار تقارنی رابطه</h1></header>
      <div className="project-layout-split">
        <div className="controls-column">
            ...
            <div className="tutorial-box">
                <h4>راهنمای سریع</h4>
                <ul>
                    <li><b>بستار تقارنی:</b> کوچکترین رابطه تقارنی است که شامل R باشد.</li>
                    <li>برای ساخت آن، به ازای هر یال (a,b)، یال بازگشتی (b,a) را نیز اضافه می‌کنیم.</li>
                </ul>
            </div>
        </div>
        <div className="results-column panel">
            ...
            {!error && originalMatrix && resultMatrix && (
                 <div className="side-by-side-display">
                    ...
                    <MatrixDisplay title="بستار تقارنی" matrix={resultMatrix} />
                </div>
            )}
        </div>
      </div>
...
export default SymmetricClosureCalculator;
